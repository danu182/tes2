                            ...
                            <form action="{{ route('item.update', $item->id) }}" method="POST">
                                ...
                                @method('PUT')
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="inputitemName6" class="form-control @error('itemName') is-invalid @enderror" aria-describedby="emailHelpInline" name="itemName" value="{{ $item->itemName ?: old('itemName') }}">
                                    </div>
                                    <div class="col-auto">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="inputuom6" class="form-control @error('uom') is-invalid @enderror" aria-describedby="emailHelpInline" name="uom" value="{{  $item->uom ?: old('uom') }}">
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                        masukkan uom.
