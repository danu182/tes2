                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('item.update', $item->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="nameItem" class="form-control @error('nameItem') is-invalid @enderror" aria-describedby="emailHelpInline" name="nameItem" value="{{ $item->nameItem ?: old('nameItem') }}">
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                        masukkan kode item.
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="foto" class="form-control @error('foto') is-invalid @enderror" aria-describedby="emailHelpInline" name="foto" value="{{ $item->foto ?: old('foto') }}">
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                        masukkan foto.
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="merek" class="form-control @error('merek') is-invalid @enderror" aria-describedby="emailHelpInline" name="merek" value="{{ $item->merek ?: old('merek') }}">
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                        masukkan merek.
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="seri" class="form-control @error('seri') is-invalid @enderror" aria-describedby="emailHelpInline" name="seri" value="{{ $item->seri ?: old('seri') }}">
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                        masukkan seri.
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="barcode" class="form-control @error('barcode') is-invalid @enderror" aria-describedby="emailHelpInline" name="barcode" value="{{ $item->barcode ?: old('barcode') }}">
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                        masukkan barcode.
