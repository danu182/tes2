                            ...
                            <form action="{{ route('pr.store') }}" method="POST">
                                @csrf
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" aria-describedby="emailHelpInline" name="title" value="{{ old('title') }}">
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                       <select class="form-select form-control" id="search" name="sister_company_id">
                                            {{-- <option value="">Select a Sister Company</option> --}}
                                        </select>
                                    </div>
                                    <div class="col-auto">
                                        <span id="emailHelpInline" class="form-text">
                                ...
                                {{-- supplier end --}}
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="col-auto">
                                        <textarea name="description" id="" cols="30" rows="10" id="description" class="form-control @error('description') is-invalid @enderror" aria-describedby="descriptionHelpInline">{{ old('description') }}</textarea>
                                    </div>
                                    <div class="col-auto">
